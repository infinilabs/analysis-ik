...
//	private Configuration cfg;
    ...
    public AnalyzeContext(boolean useSmart, boolean generateSpell) {
     ...
     * @param generateSpell
     */
    private void outputPinyin(Lexeme lexeme, boolean generateSpell) {
        if (!generateSpell) return;
    ...
    Lexeme getNextLexeme() {
        ...
        while (result != null) {
            ...
            if (Dictionary.getSingleton().isStopWord(this.segmentBuff, result.getBegin(), result.getLength())) {
                ...
                outputPinyin(result, generateSpell);
                break;
            }
        }
        return result;
